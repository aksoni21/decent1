import {createClient} from 'urql';//will create graphql client
...
`query Profile($han:Handle!) {
  profile(request: { handle: $han }) {
    id
    name
    bio
    attributes {
